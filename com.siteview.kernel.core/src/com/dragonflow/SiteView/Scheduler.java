...
import com.recursionsw.jgl.ListPriorityQueue;
...
public class Scheduler implements Runnable {
	...
	public Scheduler() {
        ...
        thread = null;
        queue = new ListPriorityQueue(new GreaterEqualTime());
...
label1:          {
    ...
    public synchronized void unschedule(Action action) {
    	ListPriorityQueue priorityqueue = new ListPriorityQueue(queue);
        queue.clear();
        do {
