...
public class Preferences extends SiteViewObject {
    ...
    public String[] addPreferences(java.util.HashMap hashmap) throws SiteViewException {
...
//            Set set = hashmap.keySet();
            String s1;
            String s4;
            for (Iterator iterator = hashmap.keySet().iterator(); iterator.hasNext(); hashmap1
                    .put(s1, s4)) {
    ...
    public String[] updatePreferences(java.util.HashMap hashmap, String s, String s1)
        ...
        do {
            ...
            try {
                ...
                Preferences preferences_27_ = (Preferences) var_class
                        .newInstance();
                java.util.HashMap hashmap = jglUtils.fromJgl(MasterConfig.getMasterConfig());
                if (hashmap == null)
                    throw new SiteViewOperationalException(
                ...
                if (s1 != null && s1.length() > 0) {
                    Enumeration enumeration = (Enumeration) hashmap.get(s1);
                    while (enumeration.hasMoreElements()) {
...
//                    Set set = hashmap_41_.keySet();
                    Iterator iterator = hashmap_41_.keys();
                    while (iterator.hasNext()) {
                        ...
                        if (stringproperty != null) {
                            String string_44_ = verify(stringproperty,
                                    string_43_, httprequest, jglUtils.fromJgl(hashmap_41_),jglUtils.fromJgl(hashmap_40_));
    ...
    public java.util.HashMap validateProperties(java.util.HashMap hashmap, Array array,
    		java.util.HashMap hashmap1) throws Exception {
    	java.util.HashMap hashmap2 = new java.util.HashMap();
        if (hashmap.get("_class") != null) {
            hashmap.remove("_class");
        }
        java.util.HashMap hashmap3 = (java.util.HashMap) hashmap.clone();
        if (array != null) {
            for (int i = 0; i < array.size(); i++) {
        ...
        if (hashmap1.size() > 0) {
            ...
            Object obj;
            for (Iterator iterator = hashmap1.keySet().iterator(); iterator.hasNext(); hashmap4
    ...
    public String verify(StringProperty stringproperty, String s,
            HTTPRequest httprequest, java.util.HashMap hashmap, java.util.HashMap hashmap1) {
        return s;
    }
    ...
    protected void checkIfValid(ScalarProperty scalarproperty, String s,
            HTTPRequest httprequest, java.util.HashMap hashmap) {
        boolean flag = false;
        flag = true;
        if (!flag) {
