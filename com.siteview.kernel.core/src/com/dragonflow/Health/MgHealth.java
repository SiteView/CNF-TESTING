...
public class MgHealth extends com.dragonflow.Health.FileBase
{
    ...
    private void buildTree()
    {
        ...
        for(int l = 0; l < mgFiles.length;l++)/*dingbing.xu add l++*/
        {
            try
            {
                Array array = com.dragonflow.Properties.FrameFile.readFromFile(com.dragonflow.SiteView.Platform.getRoot() + groupsLocation + java.io.File.separator + mgFiles[l]);
                mgs.add(array);
    ...
    public boolean fillTree(Array array, com.dragonflow.Health.FileBase.HealthNode healthnode, Array array1)
    {
    ...
    {
        Array array = TextUtils.getMultipleValues(jglUtils.toJgl(hashmap), s);
    ...
    private void checkORPHANGroups()
    {
        for(int i = 0; i < mgFiles.length; i++)
        {
            ...
            String s3 = TextUtils.getValue(jglUtils.toJgl((HashMap)array.get(0)), "_parent");
    ...
    {
        Array array = TextUtils.getMultipleValues(jglUtils.toJgl((HashMap)getAt(healthnode.frames, healthnode1.parentFrameIndex, "jgl.HashMap")), "_name");
        String s = (String)getAt(array, 0, "String");
        Array array1 = TextUtils.getMultipleValues(jglUtils.toJgl((HashMap)getAt(healthnode1.frames, 0, "jgl.HashMap")), "_name");
