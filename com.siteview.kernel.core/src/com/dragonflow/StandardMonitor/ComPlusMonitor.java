...
public class ComPlusMonitor extends BrowsableURLContentBase
{
 ...
 public Array getConnectionProperties()
 {
     ...
     array.insert(0, 0,pHostName);
     array.insert(1, 1,pPortNumber);
     array.insert(2, 2,pUserName);
     array.insert(3, 3,pPassword);
     return array;
 }
 ...
 public String verify(StringProperty stringproperty, String s, HTTPRequest httprequest, HashMap hashmap)
 {
     ...
     return super.verify(stringproperty, s, httprequest, jglUtils.toJgl(hashmap));
 }
