...
public class SQLServerMonitor extends NTCounterBase {
	...
	public String getDefaultCounters() {
		...
		System.out.println("MS SQL Server Counters:" + s);
		return s;
	}
	...
	static {
		...
		addProperties("COM.dragonflow.StandardMonitor.SQLServerMonitor",
				astringproperty);
		addClassElement("COM.dragonflow.StandardMonitor.SQLServerMonitor",
				Rule.stringToClassifier("value0 == n/a\terror", true));
		addClassElement("COM.dragonflow.StandardMonitor.SQLServerMonitor",
				Rule.stringToClassifier("always\tgood"));
		setClassProperty("COM.dragonflow.StandardMonitor.SQLServerMonitor",
				"description",
				"Monitors Microsoft SQL Server performance metrics.");
		setClassProperty("COM.dragonflow.StandardMonitor.SQLServerMonitor",
				"help", "SQLServerMon.htm");
		setClassProperty("COM.dragonflow.StandardMonitor.SQLServerMonitor",
				"title", "SQL Server");
		setClassProperty("COM.dragonflow.StandardMonitor.SQLServerMonitor",
		...
		setClassProperty("COM.dragonflow.StandardMonitor.SQLServerMonitor",
				"target", "_serverName");
		setClassProperty("COM.dragonflow.StandardMonitor.SQLServerMonitor",
				"topazName", "MS SQL Server");
		setClassProperty("COM.dragonflow.StandardMonitor.SQLServerMonitor",
				"classType", "application");
		setClassProperty("COM.dragonflow.StandardMonitor.SQLServerMonitor",
				"topazType", "Database Server");
		setClassProperty("COM.dragonflow.StandardMonitor.SQLServerMonitor",
				"applicationType", "NTCounter");
